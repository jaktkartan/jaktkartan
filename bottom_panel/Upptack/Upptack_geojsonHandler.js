...
// Funktion för att skapa Upptack_geojsonHandler efter 3 sekunders fördröjning
setTimeout(function() {
...
}, 3000); // Fördröj initialiseringen av Upptack_geojsonHandler.js med 3000 ms (3 sekunder)
