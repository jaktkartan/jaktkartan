var Kartor_geojsonHandler = (function() {
    ...
    var layerStyles = {
        'Allmän jakt: Däggdjur': {
            ...
            'Allman_jakt_daggdjur_2.geojson': { fillColor: 'blue', color: 'white', weight: 2, fillOpacity: 0.001 }
        },
        'Allmän jakt: Fågel': {
        ...
        'Älgjaktskartan': {
            ...
            'Omrdemedbrunstuppehll_2.geojson': { fillColor: 'blue', color: 'black', weight: 2, fillOpacity: 0.001 },
